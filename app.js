const KEY='gym_tycoon_v7';
const PREVKEY='gym_tycoon_v6';
...
if('serviceWorker' in navigator){
 window.addEventListener('load',async()=>{
  try{
   const reg=await navigator.serviceWorker.register('./sw.js?v=72',{updateViaCache:'none'});
   await reg.update();
